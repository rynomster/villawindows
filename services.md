...
<section class="hero hero--inner">
    ...
    <div class="hero-inner">
        ...
        <h1>Our Specialist Services</h1>
        <p>Expert timber joinery solutions for Auckland's heritage homes. We combine traditional craftsmanship with modern performance upgrades.</p>
    </div>
</section>

<section class="reveal">
    <div class="label-mono">Services overview</div>
    <h2 style="margin-bottom: 48px;">How we can help</h2>
    ...
    <div class="service-grid">
        ...
        <div class="service-card stagger-item">
            ...
            <div class="card-content">
                ...
                <a href="{{ '/our-projects' | relative_url }}" class="card-link" aria-label="View our Custom Glass and Glazing project gallery">View gallery →</a>
            </div>
        </div>
    </div>
</section>
