...
layout: default
title: Our Projects
description: Browse our gallery of heritage window restoration and double-glazing projects across Auckland. Quality timber joinery you can trust.
---
...
<section class="hero hero--inner">
    ...
    <div class="hero-inner">
        <nav class="breadcrumb">
            <a href="{{ '/' | relative_url }}">Home</a> / Projects
        </nav>
        <h1>Our Recent Projects</h1>
        <p>A collection of our heritage restoration, retrofit double-glazing, and specialist timber joinery work across Auckland.</p>
    </div>
</section>

<section class="reveal" style="max-width: 1320px;">
    <div class="label-mono">Portfolio</div>
    <h2 style="margin-bottom: 48px;">Craftsmanship in focus</h2>
...
<section class="cta-box bg-dark full-width">
    ...
    <div class="container reveal">
        <div class="label-mono" style="color:var(--color-primary-light); justify-content:center;">Get in touch</div>
        <h2>Ready to start your own project?</h2>
        <p>We'd love to help you restore and upgrade your timber windows.</p>
