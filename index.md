...
<section class="bg-dark full-width">
    <div class="reveal" style="max-width: 1280px; margin: 0 auto; padding: 0 clamp(20px, 5vw, 64px);">
        <div class="label-mono" style="color:var(--color-primary-light);">Why us</div>
        <h2 style="color:#fff; margin-bottom: 48px;">Why homeowners choose Villa Windows</h2>
...
<section class="cta-box bg-dark full-width">
    ...
    <div class="container reveal">
        <div class="label-mono" style="color:var(--color-primary-light); justify-content:center;">Have a question?</div>
